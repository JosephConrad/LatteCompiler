...
public class CondElse extends Stmt {
    ...
    public void checkTypes(Env env, String currentFunction) throws TypeException {
        if (expr_.returnExprType(env, currentFunction) != "boolean")
            throw new TypeException(currentFunction, "expresion in conditional statment must return boolean ");
        stmt_1.checkTypes(env, currentFunction);
        stmt_2.checkTypes(env, currentFunction);
    }
